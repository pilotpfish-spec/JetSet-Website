...
# --- pristine Prisma schema (no BOM, no weird quotes) ---
$schemaLines = @(
...
[System.IO.File]::WriteAllText($schemaPath, ($schemaLines -join "`r`n"), $utf8NoBom)

# Prisma format + generate using npx.cmd (avoid npm.ps1 wrapping bug)
...
Write-Host "OK: schema.prisma replaced and Prisma client generated."
