...
# Full schema goes inside a here-string, now properly terminated
$schemaText = @'
...
# Write schema text out (UTF-8 no BOM)
...
Write-Host "OK: Overwrote schema (UTF-8 no BOM) and generated Prisma client."
