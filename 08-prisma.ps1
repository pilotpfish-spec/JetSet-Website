...
Set-Content -Encoding UTF8 -Path "prisma\schema.prisma" -Value @'
...
# Use the .cmd launcher to avoid the PowerShell shim problem
...
Write-Host "OK: Prisma schema written and client generated."
